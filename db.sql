...
INSERT INTO `admin_users_roles_links` VALUES (1,1,1,1,1),(8,2,4,1,1);
...
INSERT INTO `categories` VALUES (1,'Audio/Video','text','2023-12-05 21:17:56.095000','2023-12-05 21:18:50.277000','2023-12-05 21:18:50.273000',1,1,'de'),(2,'Animation','text','2023-12-05 21:18:37.713000','2023-12-05 21:18:44.060000','2023-12-05 21:18:44.055000',1,1,'de'),(3,'Games/XR','text','2023-12-05 21:19:02.171000','2023-12-05 21:19:02.972000','2023-12-05 21:19:02.966000',1,1,'de'),(4,'Web/App','text','2023-12-05 21:19:14.620000','2023-12-05 21:19:16.183000','2023-12-05 21:19:16.177000',1,1,'de');
...
--
-- Table structure for table `categories_project_links`
--

DROP TABLE IF EXISTS `categories_project_links`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `categories_project_links` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `category_id` int unsigned DEFAULT NULL,
  `project_id` int unsigned DEFAULT NULL,
  `category_order` double unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `categories_project_links_unique` (`category_id`,`project_id`),
  KEY `categories_project_links_fk` (`category_id`),
  KEY `categories_project_links_inv_fk` (`project_id`),
  KEY `categories_project_links_order_inv_fk` (`category_order`),
  CONSTRAINT `categories_project_links_fk` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  CONSTRAINT `categories_project_links_inv_fk` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `categories_project_links`
--

LOCK TABLES `categories_project_links` WRITE;
/*!40000 ALTER TABLE `categories_project_links` DISABLE KEYS */;
INSERT INTO `categories_project_links` VALUES (1,3,1,4),(2,4,1,3),(3,2,1,2),(4,1,1,1);
/*!40000 ALTER TABLE `categories_project_links` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `components_project_galeries`
--

DROP TABLE IF EXISTS `components_project_galeries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `components_project_galeries` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `components_project_galeries`
--

LOCK TABLES `components_project_galeries` WRITE;
/*!40000 ALTER TABLE `components_project_galeries` DISABLE KEYS */;
/*!40000 ALTER TABLE `components_project_galeries` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `components_project_semesters` VALUES (1,6,'Bachelor','Medientechnik und -design'),(5,6,'Bachelor','Medientechnik und -design');
...
INSERT INTO `projects` VALUES (1,'Peek Beyond','2023-12-05 19:46:20.109000','2023-12-05 21:31:57.491000',NULL,1,1,'de','texttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttexttext',NULL),(2,'Peek Beyond','2023-12-05 20:46:02.986000','2023-12-05 21:31:57.535000',NULL,1,1,'en','Lol',NULL);
...
INSERT INTO `projects_components` VALUES (1,1,1,'project.semester','DegreeAndSemester',1),(8,2,5,'project.semester','DegreeAndSemester',1);
...
INSERT INTO `projects_main_category_links` VALUES (1,1,3);
...
INSERT INTO `up_permissions` VALUES (1,'plugin::users-permissions.user.me','2023-11-21 18:52:24.519000','2023-11-21 18:52:24.519000',NULL,NULL),(2,'plugin::users-permissions.auth.changePassword','2023-11-21 18:52:24.519000','2023-11-21 18:52:24.519000',NULL,NULL),(3,'plugin::users-permissions.auth.callback','2023-11-21 18:52:24.534000','2023-11-21 18:52:24.534000',NULL,NULL),(4,'plugin::users-permissions.auth.connect','2023-11-21 18:52:24.534000','2023-11-21 18:52:24.534000',NULL,NULL),(5,'plugin::users-permissions.auth.forgotPassword','2023-11-21 18:52:24.534000','2023-11-21 18:52:24.534000',NULL,NULL),(6,'plugin::users-permissions.auth.resetPassword','2023-11-21 18:52:24.534000','2023-11-21 18:52:24.534000',NULL,NULL),(7,'plugin::users-permissions.auth.register','2023-11-21 18:52:24.534000','2023-11-21 18:52:24.534000',NULL,NULL),(8,'plugin::users-permissions.auth.sendEmailConfirmation','2023-11-21 18:52:24.534000','2023-11-21 18:52:24.534000',NULL,NULL),(9,'plugin::users-permissions.auth.emailConfirmation','2023-11-21 18:52:24.534000','2023-11-21 18:52:24.534000',NULL,NULL),(13,'api::category.category.findLatest','2023-12-05 22:11:41.066000','2023-12-05 22:11:41.066000',NULL,NULL),(14,'api::category.category.find','2023-12-05 22:11:41.066000','2023-12-05 22:11:41.066000',NULL,NULL),(15,'api::category.category.findOne','2023-12-05 22:11:41.066000','2023-12-05 22:11:41.066000',NULL,NULL),(16,'api::event.event.find','2023-12-05 22:11:41.066000','2023-12-05 22:11:41.066000',NULL,NULL),(17,'api::event.event.findOne','2023-12-05 22:11:41.066000','2023-12-05 22:11:41.066000',NULL,NULL),(18,'api::project.project.find','2023-12-05 22:11:41.066000','2023-12-05 22:11:41.066000',NULL,NULL),(19,'api::project.project.findOne','2023-12-05 22:11:41.066000','2023-12-05 22:11:41.066000',NULL,NULL);
...
INSERT INTO `up_permissions_role_links` VALUES (1,1,1,1),(2,2,1,1),(3,3,2,1),(4,4,2,1),(5,8,2,1),(6,7,2,1),(7,6,2,2),(8,5,2,2),(9,9,2,2),(13,13,2,3),(14,14,2,3),(15,16,2,3),(16,15,2,3),(17,19,2,4),(18,17,2,4),(19,18,2,4);
...
INSERT INTO `up_roles` VALUES (1,'Authenticated','Default role given to authenticated user.','authenticated','2023-11-21 18:52:24.504000','2023-11-21 18:52:24.504000',NULL,NULL),(2,'Public','Default role given to unauthenticated user.','public','2023-11-21 18:52:24.509000','2023-12-05 22:14:51.626000',NULL,NULL);
...
-- Dump completed on 2023-12-05 22:15:20
